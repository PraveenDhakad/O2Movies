...
<div id="single" class="dtsingle">
    ...
    <div class="content">
        ...
        <div id="info" class="sbox">
           ...
           <p style="text-align: center;"><span style="font-size: 12pt; color: #ff0000; font-family: 'book antiqua', palatino, serif;"><strong>Share with Your Friends If you like our Website :-)</strong></span><br><span style="font-size: 12pt; color: #ff0000; font-family: 'book antiqua', palatino, serif;"><strong>Don&rsquo;t Forget to Bookmark Our Website :-)</strong></span> </p><br>
            <img class="aligncenter wp-image-36" alt="<?php the_title(); ?>" width="328" height="492" src="<?php echo get_the_post_thumbnail(); ?><br>
            <div style='font-family: "Times New Roman", Times, serif; font-size: 17px;' itemprop="description" class="wp-content">
            <span style="font-family: georgia, palatino, serif;"><span style="color: #ff0000;"><strong>Description</strong> </span>: <?php the_content(); ?></span><hr>
                ...
                <p style="text-align: left;"><span style="font-family: georgia, palatino, serif;"><strong><span style="font-size: 14px;">Title:</span></strong><span style="font-size: 14px;">&nbsp;<?php the_title(); ?></span></span><span style="font-size: 14px;"><br><span style="font-family: georgia, palatino, serif;"><strong>Genre:&nbsp;</strong><!-- Grnre List --><strong>&nbsp;</strong></span><br><span style="font-family: georgia, palatino, serif;"><strong>Release Date:</strong>&nbsp;<?php if($d = doo_isset($postmeta,'release_date')) echo "<span class='date'>".doo_date_compose($d,false)."</span>"; ?></span><br><span style="font-family: georgia, palatino, serif;"><strong>Trailer:</strong> Watch</span><br><span style="font-family: georgia, palatino, serif;"><strong>RUNTIME:&nbsp;Not Available </strong></span><br><span style="font-family: georgia, palatino, serif;"><strong>Category:&nbsp;</strong><a href="<?php echo site_url('/genre/hollywood-movie/') ?>" rel="noopener noreferrer" target="_blank">Hollywood Movies</a></span><br><span style="font-family: georgia, palatino, serif;"><strong>Language:&nbsp;</strong>Dual Audio</span><br><span style="font-family: georgia, palatino, serif;"><strong>Information Source:</strong> WIKIPEDIA</span><br><span style="font-family: georgia, palatino, serif;"><strong>IMDB:&nbsp;https://www.imdb.com/title/......../</strong></span><br><span style="font-family: georgia, palatino, serif;"><strong><span style="color: #00ff00;">Subtitles</span>:</strong> Download Movie Subtitles (Arabic, English, Hindi &hellip;..) <?php the_title(); ?> Subtitles For Free Here.</span><br><span style="font-family: georgia, palatino, serif;"><span style="color: #ff00ff;"><strong>Skip Directly To Download:</strong></span> <a href="<?php echo site_url(); ?>" rel="noopener noreferrer" target="_blank">Click Here</a></span>&nbsp;</span></p>
                <hr>
