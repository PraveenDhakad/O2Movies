    ...
    'sections' => array(
        ...
        array(
            ...
            'fields' => array(
                ...
                array(
                    'type' => 'heading',
                    'content' => __d('List of seasons and episodes')
                ),

                array(
                    'id'      => 'sortseason',
                    'type'    => 'radio',
                    'title'   => __d('Seasons List'),
                    'desc'    => __d('Sort seasons list'),
                    'options' => array(
                        'asc'  => __d('Ascending'),
                        'desc' => __d('Descending')
                    ),
                ...
                array(
                    'id'      => 'sortepisodes',
                    'type'    => 'radio',
                    'title'   => __d('Episodes List'),
                    'desc'    => __d('Sort episodes list'),
                    'options' => array(
                        'asc'  => __d('Ascending'),
                        'desc' => __d('Descending')
                    ),
                ...
                array(
                    'type' => 'heading',
                    'content' => __d('Requests page')
                ),

                array(
                    'id'    => 'requestunknown',
                    'type'  => 'checkbox',
                    'title' => __d('Unknown user'),
                    'label' => __d('Unknown users can publish requests?')
                ),

                array(
                    'type' => 'notice',
                    'class' => 'warning',
                    'content' => __d('Unregistered users can add content to the database'),
                    'dependency' => array('requestunknown', '==', true)
                ),

                array(
                    'id'    => 'requestpublisherole',
                    'type'  => 'checkbox',
                    'title' => __d('Auto publish'),
                    'desc'  => __d('Mark user roles that do not require content moderation'),
                    'options' => array(
        ...
        array(
            ...
            'fields' => array(
                ...
                array(
                    ...
                    'type'    => 'switcher',
                    'title'   => __d('Safe mode'),
                    'label'    => __d('Method safe, the process will continue only if the above process is completed'),
                    'default' => false
                ),
                ...
                array(
                    'id'      => 'dbmvsdelaytime',
                    'type'    => 'number',
                    'title'   => __d('Delay time'),
                    'desc'    => __d('Time in milliseconds to execute the next importation'),
                    'default' => '500',
                    'attributes' => array(
                        'style' => 'width:100px'
                    ),
                    'dependency' => array('dbmvssafemode', '==', false)
                ),

                array(
                    'type' => 'heading',
                    'content' => __d('PHP Limits')
                ),

                array(
                    'id'      => 'dbmvsphptime',
                    'type'    => 'number',
                    'title'   => __d('Set time limit'),
                    'desc'    => __d('Help extend the execution time'),
                    'default' => '300',
                    'attributes' => array(
                        'style' => 'width:100px'
                    )
                ...
                array(
                    ...
                    'type'    => 'text',
                    'title'   => __d('Movies'),
                    'after'   => '<p><strong>Tags:</strong> {name} {year}</p>',
                    'default' => '{name}'
                ),

                array(
                    'id'      => 'dbmvstitletvshows',
                    'type'    => 'text',
                    'title'   => __d('TV Shows'),
                    'after'   => '<p><strong>Tags:</strong> {name} {year}</p>',
                    'default' => '{name}'
                ...
                array(
                    'id'      => 'dbmvstitleseasons',
                    'type'    => 'text',
                    'title'   => __d('Seasons'),
                    'after'   => '<p><strong>Tags:</strong> {name} {season}</p>',
                    'default' => __d('{name}: Season {season}')
                ),

                array(
                    'id'      => 'dbmvstitleepisodes',
                    'type'    => 'text',
                    'title'   => __d('Episodes'),
                    'after'   => '<p><strong>Tags:</strong> {name} {season} {episode}</p>',
                    'default' => '{name}: {season}x{episode}'
                ),
        ...
        array(
            ...
            'fields' => array(
                ...
                array(
                    'id'      => 'jwlibrary',
                    'type'    => 'text',
                    'title'   => __d('Library Url'),
                    'desc'    => __d('Cloud Hosted Player Libraries'),
                    'default' => 'https://content.jwplatform.com/libraries/oqxCz8Dy.js',
                    'dependency' => array('jwversion_jw8', '==', true)
                ),
                ...
                array(
                    ...
                    'dependency' => array('jwversion_jw7', '==', true)
                ),
