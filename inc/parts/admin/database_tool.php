        ...
        <div id="doobox_license" class="postbox">
            ...
            <div class="inside">
                ...
                <p>
                    ...
                    <span id="doodatabasetool_license" class="agotime"><?php echo ($timerun['license']) ? human_time_diff($timerun['license'], current_time('timestamp')) : $never; ?></span>
                </p>
            </div>
        </div>
        <div id="doobox_transients" class="postbox">
            ...
            <div class="inside">
                ...
                <p>
                    ...
                    <span id="doodatabasetool_transients" class="agotime"><?php echo ($timerun['transients']) ? human_time_diff($timerun['transients'], current_time('timestamp')) : $never; ?></span>
                </p>
            </div>
        </div>
        <div id="doobox_userfavorites" class="postbox">
            ...
            <div class="inside">
                ...
                <p>
                    ...
                    <span id="doodatabasetool_userfavorites" class="agotime"><?php echo ($timerun['userfavorites']) ? human_time_diff($timerun['userfavorites'], current_time('timestamp')) : $never; ?></span>
                </p>
            </div>
        </div>
        <div id="doobox_userviews" class="postbox">
            ...
            <div class="inside">
                ...
                <p>
                    ...
                    <span id="doodatabasetool_userviews" class="agotime"><?php echo ($timerun['userviews']) ? human_time_diff($timerun['userviews'], current_time('timestamp')) : $never; ?></span>
                </p>
            </div>
        </div>
        <div id="doobox_reports" class="postbox">
            ...
            <div class="inside">
                ...
                <p>
                    ...
                    <span id="doodatabasetool_reports" class="agotime"><?php echo ($timerun['reports']) ? human_time_diff($timerun['reports'], current_time('timestamp')) : $never; ?></span>
                </p>
            </div>
        </div>
        <div id="doobox_ratings" class="postbox">
            ...
            <div class="inside">
                ...
                <p>
                    ...
                    <span id="doodatabasetool_ratings" class="agotime"><?php echo ($timerun['ratings']) ? human_time_diff($timerun['ratings'], current_time('timestamp')) : $never; ?></span>
                </p>
            </div>
        </div>
        <div id="doobox_featured" class="postbox">
            ...
            <div class="inside">
                ...
                <p>
                    ...
                    <span id="doodatabasetool_featured" class="agotime"><?php echo ($timerun['featured']) ? human_time_diff($timerun['featured'], current_time('timestamp')) : $never; ?></span>
                </p>
            </div>
        </div>
        <div id="doobox_postviews" class="postbox">
            ...
            <div class="inside">
                ...
                <p>
                    ...
                    <span id="doodatabasetool_postviews" class="agotime"><?php echo ($timerun['postviews']) ? human_time_diff($timerun['postviews'], current_time('timestamp')) : $never; ?></span>
                </p>
            </div>
        </div>
    </div>
