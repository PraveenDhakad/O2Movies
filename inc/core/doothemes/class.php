...
class Doothemes {
	...
	*/
	function license_page() {
		...
		// Start page
	    echo '<div class="wrap about-wrap h2_dt_boxs" style="max-width: 100%">';
		echo '<h1>License <strong>'. $this->item_name . ' ' . $this->version . '</strong></h1>';
		echo '<div class="about-text"><i class="fa fa-key" aria-hidden="true"></i><strong>Doothemes License Key:</strong> <font color="#24c52a">Streamal.me</font> 
		
		<p><span style=" padding: 0 3px; display: inline-block; border-right-color: #3593e1; color: #3593e1; font-weight: normal !important; border-bottom: 1px solid; cursor: default; "><i class="fa fa-thumb-tack" aria-hidden="true"></i> Information</span>
		<br /><span style="font-weight: normal !important"><i class="fa fa-square" aria-hidden="true" style="color: #3593e1"></i> <b>Contact Shadow via mail <a href="mailto:streamaly@gmail.com">Streamaly@gmail.com</a>.
		<br /><i class="fa fa-bug" aria-hidden="true" style="color: #3593e1"></i> <b>Found a bug?</b> Please report it <a href="https://streamal.me">here</a> within Dooplay 2.2.3 thread by Shadow.
		<br /> <i class="fa fa-info-circle" aria-hidden="true" style="color: #3593e1"></i> <font color="crimson"><b>DO NOT</b></font> share this version on other sites, or the API server will be shut down. <font color="crimson">(And this Dooplay version will be unusable)</p></font></span>
		<p><span style=" padding: 0 3px; display: inline-block; color: #e1353e; font-weight: normal !important; border-bottom: 1px solid #e1353e; cursor: default; ">';
		...
		echo '<tr><td>';
		echo '<input id="'.$idkey.'" name="'.$idkey.'" type="text" class="dt_text_license dt_'.$status.'" value="streamal.me" placeholder="'. __d('License'). '"/>';
