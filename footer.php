...
// Copyright
$copytext = sprintf( __d('%s %s by %s. All Rights Reserved. Powered by %s'), '&copy;', date('Y'), '<strong>'.get_option('blogname').'</strong>', '<a href="https://doothemes.com"><strong>DooThemes</strong></a>' );
