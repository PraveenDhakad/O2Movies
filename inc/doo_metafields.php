	...
	*/
    class Doofields {
        ...
        public function generator($args) {
            ...
            $text_buttom  = $this->meta($id) ? __('Update info') : __('Generate');
            ...
            $output .= "<input type='button' class='button button-primary' name='generate_data_api' id='generate_data_api' value='{$text_buttom}'>";
    		$output .= "<p class='description'>{$fdesc}</p>";
    		$output .= "<p id='verificador' style='display:none'><a class='button button-secundary' id='comprovate'>{$text_duplic}</a><p>";
    		$output .= "</td></tr>";
            // Compose view
            return $output;
        }
